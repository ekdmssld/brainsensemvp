# Arduino Shop - 아두이노 전문 쇼핑몰

## 프로젝트 개요
Spring Boot 기반의 아두이노 전문 온라인 쇼핑몰입니다. 아두이노 보드, 센서, 모터, 디스플레이 등 다양한 아두이노 관련 제품을 판매하며, 상품 관리, 주문 처리, 고객 서비스 등 전자상거래의 핵심 기능을 제공합니다.
...
- data.sql 파일을 통한 초기 데이터 로드
  - 아두이노 보드 (UNO R3, MEGA 2560, Nano)
  - 센서 (DHT11/DHT22 온습도 센서, HC-SR04 초음파 센서, PIR 모션 센서)
  - 모터/액추에이터 (SG90 서보 모터, MG996R 서보 모터, 스텝 모터)
  - 디스플레이 (LCD, OLED)
  - 부품/케이블 (점퍼 와이어, 브레드보드, USB 케이블)
